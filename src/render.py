...
main{max-width:1400px;margin:0 auto;padding:8px 24px 96px}
...
footer{position:fixed;left:0;right:0;bottom:0;z-index:11;background:rgba(15,17,21,.94);
  backdrop-filter:blur(8px);border-top:1px solid var(--line);padding:7px 24px;
...
@media(max-width:640px){.grid{grid-template-columns:1fr}header,main{padding-left:16px;padding-right:16px}
  main{padding-bottom:130px}footer{padding:6px 16px;font-size:11px}}
"""
